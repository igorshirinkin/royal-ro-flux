...
return array(
	'ServerAddress'				=> 'royal-ro.na4u.ru',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> '/',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> 'Igor2247380',		// Installer/updater password.
	...
	'DefaultLanguage'			=> 'russian',				// Specify the default control panel language (see FLUX_ROOT/lang/ directory for available languages.)
	'SiteTitle'					=> 'Ragnarok Online Royal',	// This value is only used if the theme decides to use it.
	'ThemeName'					=> array('purple_themes', 'hurtFreeV2'), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
	...
	'ForwardYears'				=> 10,						// (Visual) The number of years to display ahead of the current year in date inputs.
	'BackwardYears'				=> 40,						// (Visual) The number of years to display behind the current year in date inputs.
	...
	'MinDonationAmount'			=> 100.0,						// Minimum donation amount. (NOTE: Actual donations made that are less than this account won't be exchanged)
	'DonationCurrency'			=> 'RUB',					// Preferred donation currency. Only donations made in this currency will be processed for credit deposits.
	...
	'ChargeGenderChange'		=> 50,						// You can specify this as the number of credits to charge for gender change.  Can be 0 for free change.
	...
	'CharRankingLimit'			=> 50,						//
	'GuildRankingLimit'			=> 50,						//
	'ZenyRankingLimit'			=> 50,						//
	'DeathRankingLimit'			=> 50,						//
	'AlchemistRankingLimit'		=> 50,						//
	'BlacksmithRankingLimit'	=> 50,						//
	'HomunRankingLimit'			=> 50,						//
	'MVPRankingLimit'			=> 50,						//
	...
	'MenuItems'		=> array(
		...
		'DonationsLabel'		=> array(
			//'PurchaseLabel'		=> array('module' => 'purchase'), // Cash shop
		...
		'SocialLabel'		=> array(
			'Telegram'		=> array('exturl' => '<link_to_RMS>'),
			'JoinUsInVKLabel'		=> array('exturl' => '<link_to_RMS>'),
			//'JoinUsInInstagramLabel'=> array('exturl' => '<link_to_RMS>'),
			//'JoinUsInFacebookLabel'	=> array('exturl' => 'https://www.facebook.com/<change_me>'),
			'JoinUsInDiscordLabel'	=> array('exturl' => 'https://www.facebook.com/<change_me>'),
	...
	'SubMenuItems'			=> array(
		...
		'account'			=> array(
			'index'			=> 'Список аккаунтов',
			'view'			=> 'Посмотреть учётную запись',
			'changepass'	=> 'Сменить пароль',
			'changemail'	=> 'Сменить E-mail',
			'changesex'		=> 'Сменить пол',
			'transfer'		=> 'Перевести кредиты',
			'xferlog'		=> 'История операций',
			'cart'			=> 'Перейти в корзину',
			'login'			=> 'Логин',
			'create'		=> 'Зарегистрироваться',
			'resetpass'		=> 'Сбросить пароль',
			'resend'		=> 'Повторить активацию'
		),
		'guild'				=> array(
			'index'			=> 'Гильдии',
			'export'		=> 'Экспортировать эмблемы гильдии'
		),
		'server'			=> array(
		...
		'purchase'			=> array(
			'index'			=> 'Магазин',
			'cart'			=> 'Перейти в корзину',
			'checkout'		=> 'Проверить корзину',
			'clear'			=> 'Очистить корзину',
			'pending'		=> 'Pending Redemption'
		),
		'donate'			=> array(
			'index'			=> 'Сделать пожертвование',
			'history'		=> 'История пожертвований',
			'trusted'		=> 'Доверенные PayPal E-mails'
		),
		'ipban'				=> array(
			'index'			=> 'Список заблокированных IP-адресов',
			'add'			=> 'Заблокировать IP-адрес'
		),
		'ranking'			=> array(
			'character'		=> 'Персонажи',
			'death'			=> 'Смерти',
		...
		'item'				=> array(
			'index'			=> 'Список вещей',
			'add'			=> 'Добавить вещь',
			'iteminfo'		=> 'Добавить описание вещей',
		),
		'pages'				=> array(
			'index'			=> 'Управлять контентом',
			'add'			=> 'Добавить новую страницу',
		),
		'news'				=> array(
			'index'			=> 'Последние новости',
			'manage'		=> 'Управлять контентом',
			'add'			=> 'Добавить новость',
		),
		'servicedesk'		=> array(
			'staffindex'	=> 'Посмотреть активные',
			'staffviewclosed' => 'Посмотреть закрытые',
			'staffsettings'	=> 'Настройки персонала',
			'catcontrol'	=> 'Настройки категорий',
		),
		'vending'			=> array(
			'index'			=> 'Продавцы',
		),
