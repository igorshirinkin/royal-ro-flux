...
return array(
	...
	array(
		...
		'DbConfig'       => array(
			...
			'Hostname'   => 'localhost',
			'Username'   => 'root',
			'Password'   => 'LzT3PWUhjfxcK9s',
			'Database'   => 'ragnarok',
			'Persistent' => true,
			'Timezone'   => 'Europe/Moscow' // Example: '+0:00' is UTC.
		...
		'LogsDbConfig'   => array(
			...
			'Persistent' => true,
			'Timezone'   => 'Europe/Moscow' // Possible values is as described in the comment in DbConfig.
		),
		...
		'CharMapServers' => array(
			array(
				...
				'Renewal'         => true,
				'MaxCharSlots'    => 15,
				'DateTimezone'    => 'Europe/Moscow', // Specifies game server's timezone for this char/map pair. (See: http://php.net/timezones)
				//'ResetDenyMaps'   => 'sec_pri', // Defaults to 'sec_pri'. This value can be an array of map names.
				'Database'        => 'ragnarok', // Defaults to DbConfig.Database
				'ExpRates' => array(
					'Base'        => 750, // Rate at which (base) exp is given
					'Job'         => 750, // Rate at which job exp is given
