			...
			<div id="social" class="column has-background-custom1 box">
				<nav class="level">
					...
					<div class="level-right">
						<div class="level-item">
							<p class="heading has-text-white">Подписывайтесь на нас</p>
						</div>

						<div class="level-item"> </div>

						<?php if ($hurtsky['enableTelegramIcon']) : ?>
							<div class="level-item">
								<a class="icon is-medium has-text-white" href="<?php echo $hurtsky['TelegramLink']; ?>" target="_blank">
									<img src="themes/hurtFreeV2/img/free-icon-telegram-152827.png" alt="telegram">
								</a>
							</div>
						<?php endif ?>
						...
						<?php if ($hurtsky['enableFacebookIcon']) : ?>
							<div class="level-item">
								<a class="icon is-medium has-text-white" href="<?php echo $hurtsky['facebookLink']; ?>" target="_blank">
									<img src="themes/hurtFreeV2/img/facebook.png" alt="facebook">
								</a>
							</div>
						<?php endif ?>
						...
						<?php if ($hurtsky['enableVKIcon']) : ?>
							<div class="level-item">
								<a class="icon is-medium has-text-white" href="<?php echo $hurtsky['VKLink']; ?>" target="_blank">
									<img src="themes/hurtFreeV2/img/vk-social-network-logo.png" alt="VK">
								</a>
							</div>
						<?php endif ?>
						...
						<?php if ($hurtsky['enableDiscordIcon']) : ?>
							<div class="level-item">
								<a class="icon is-medium has-text-white" href="<?php echo $hurtsky['discordInviteLink']; ?>" target="_blank">
									<img src="themes/hurtFreeV2/img/discord.png" alt="discord">
								</a>
							</div>
						<?php endif ?>
...
<div class="hero-foot has-background-custom1 has-text-white">
	<nav id="footer">
		...
		<div class="disclaimer">
			<img src="themes/hurtFreeV2/img/disclaimer.png" alt="disclaimer">
		</div>
		...
		<div class="container">
			...
			<p class="has-text-centered">
				© Copyright 2002 - <?php echo date("Y"); ?> Gravity Co., Ltd. / Lee Myoungjin
			</p>
			<p class="has-text-centered">
				© Copyright <?php echo date("Y"); ?> RoyalRO
			</p>
			<p class="has-text-centered">
				Неофициальный сервер Ragnarok Online.
			</p>
		</div>
